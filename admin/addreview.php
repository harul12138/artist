...
{  
   ...
   mysql_query("set names 'utf8'");
     $sql = "INSERT INTO `news` (`title` ,`date` ,`writer`,`website`,`picture`,`content`,`category`) 
     VALUES ('$fileTitle' , '$date' ,'$writer','$website','$fileName','$fileInfo','$category')";
       
          $result=mysql_query($sql);  
          if($result>0)
        {  
         echo"<script type='text/javascript'>alert('上传成功');; 
      location='addreview.php';</script>"; 
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<div class="alert alert-info">
											...
											本部分主要是上传与艺术家相关的文章评论，如他人为艺术家作的序或写的作品评论
											<br />
										</div>
                                <form class="form-horizontal" role="form" action="addreview.php" method="post" enctype="multipart/form-data" >
											...
											<div class="widget-box">
												<div class="widget-header">
													...
													<span class="help-button" data-rel="popover" data-trigger="hover" 
														data-placement="left" data-content="配图可使用画家作品图片，尺寸宽度尽量在1920左右" title="可为空">?</span>
												</div>
                           ...
                           <hr/>
                                  ...
                                  <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="writer" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="space-8"></div>
										...
										<div class="col-sm-9">
											<input readonly="" type="text" class="col-xs-10 col-sm-5" name="category" id="form-input-readonly" value="艺术礼记" />
                                 ...
                                 <div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<textarea class="form-control editable" name="content" id="about" rows="12"></textarea>
										</div>
									</div>
