...
{  
 ...
 mysql_query("set names 'utf8'");
      $sql = "insert into timeline (date,event) values ('".$date. "','".$event. "')";
          $result=mysql_query($sql);  
        if(!$result)  
        {  
          echo"<script type='text/javascript'>alert('事件发布失败');; 
      location='adtimeline.php';</script>"; 
     
        }  
        else   
        {  
             echo"<script type='text/javascript'>alert('事件发布成功');; 
      location='adtimeline.php';</script>"; 
        }  
  }
  }
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="adtimeline.php" method="post">
