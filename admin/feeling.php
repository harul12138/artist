    ...
    if(!strcmp($reqAct,"delete"))
    {
      ...
      if(intval($id)>=0)
      {
         ...
         if(!$result)
        {
          ...
          echo"<script type='text/javascript'>window.alert('文章删除失败');; 
      location='feeling.php';</script>"; 
        }
        else
        {
          echo"<script type='text/javascript'>window.alert('文章删除成功');; 
      location='feeling.php';</script>"; 
        }
      }
    }
...
?>
		...
		<div class="main-container" id="main-container">
            ...
            <?php
             ...
             mysql_query("set names 'utf8'");
              $re="select * from news where category='艺术感悟' order by id DESC";
    ...
    {   ?>
													...
													<td><?php echo $ff["title"];?></td>
                                                  <td><?php echo mb_strlen($ff['content'], 'utf-8') > 50 ? mb_substr($ff['content'], 0, 50, 'utf-8').'....' : $ff['content'];?></td>

														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

																<a class="green" href="editfeeling.php?action=modify&id=<?php echo $ff["id"];?>" title="Edit" >
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="feeling.php?action=delete&amp;id=<?php echo $ff["id"];?>" title="Delete">
