	...
	<body>
		...
		<div class="main-container" id="main-container">
	      ...
	      $list=mysql_fetch_array($sq);?> 
								<a href="../gallery/uploads/portfolio/<?php echo $list["img"];?>" data-rel="colorbox">
												<img alt="150x150" src="../gallery/uploads/portfolio/<?php echo $list["img"];?>" height="200" width="200" />
												<div class="text">
											...
											<div class="tools tools-bottom">
												...
												<a href="editpro.php?action=modify&id=<?php echo $list["id"];?>">
													<i class="icon-pencil"></i>
												</a>
