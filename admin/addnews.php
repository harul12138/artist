    ...
    if(!strcmp($reqAct,"upload"))
{
 ...
 $uploads_dir = '../gallery/uploads/news/';
 ...
 $fileInfo=$_POST['content'];
       
  
  if($fileTitle==""||$fileInfo=="")  
{  
    echo"内容不能为空";  

}else{ 
   mysql_query("set names 'utf8'");
     $sql = "INSERT INTO `news` (`title` ,`date` ,`website`,`picture`,`content`,`category`) 
     VALUES ('$fileTitle' , '$date' ,'$website','$fileName','$fileInfo','$category')";
       
          $result=mysql_query($sql);  
          if($result>0)
        {  
         echo"<script type='text/javascript'>alert('上传成功');; 
      location='addnews.php';</script>"; 
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" action="addnews.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="action" value="upload">
                                    <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 动态图片 </label>
                                 <div class="col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													...
													<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="若无相关新闻图片则适用默认配图" title="可为空">?</span>
												</div>
                           ...
                           <hr/>
														...
														<div class="row">
															<div class="col-xs-6 col-sm-3">
																<div class="input-group">
																	<input class="form-control date-picker" name="date" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd"/>
									...
									<div class="space-8"></div>
										...
										<div class="col-sm-9">
											<input readonly="" name="category" type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="个人新闻" />
                               ...
                               <div class="form-group">
										...
										<div class="col-sm-9">
											<input name="website" data-rel="tooltip" type="text" id="form-field-6" placeholder="www.XXXX.com"data-placement="bottom" />
											<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="可为空" title="填写与新闻相关的链接">?</span>
										</div>
									</div>
                                 ...
                                 <div class="space-4"></div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">新闻内容</label>

										<div class="col-sm-6">
											<textarea name="content" class="form-control editable" id="about" rows="8"></textarea>
										</div>
									</div>
