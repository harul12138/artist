		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
             ...
             mysql_query("set names 'utf8'");
              $aa="select * from artwork order by id DESC";
              $alist=mysql_query($aa);
    
      while( $ar=mysql_fetch_array($alist))
    {   
      ?>                           
										<li>
											<a href="../gallery/uploads/artwork/<?php echo $ar["picture"];?>" data-rel="colorbox">
												<img alt="210x210" src="../gallery/uploads/artwork/<?php echo $ar["picture"];?>" width="210" height="210"/>
												<div class="text">
													<div class="inner"><?php echo $ar["category"];?>
													</br><?php echo $ar["title"];?></div>
											...
											<div class="tools tools-bottom">
												...
												<a href="editwork.php?action=modify&id=<?php echo $ar["id"];?>" title="Edit">
													<i class="icon-pencil"></i>
												</a>

												<a href="artwork.php?action=delete&amp;id=<?php echo $ar["id"];?>" title="Delete">
