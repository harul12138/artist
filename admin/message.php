    ...
    if(!strcmp($reqAct,"delete"))
    {
      ...
      if(intval($id)>=0)
      {
         ...
         if(!$result)
        {
          ...
          echo"<script type='text/javascript'>alert('留言删除失败');; 
      location='message.php';</script>"; 
        }
        else
        {
          echo"<script type='text/javascript'>alert('留言删除成功');; 
      location='message.php';</script>"; 
        }
      }
    }
	...
	<body>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
              ...
              <tr height="30">
              <td style="text-align:center;width=15%">用户昵称</td>
              <td style="text-align:center;width:55%">留言内容</td>
			  <td style="text-align:center;width:20%">留言时间</td>
              <td style="text-align:center;width:10%">删除留言</td>
            </tr>
            <?php
             require_once ("mysql_connect.php");
             mysql_query("set names 'utf8'");
              $al="select * from board order by date DESC";
              $mlist=mysql_query($al);
    
      while( $mess=mysql_fetch_array($mlist))
    {   ?>
   
            <tr height="35">
                    <td align="center"><?php echo $mess["name"];?></td>
                     <td align="center"><?php echo $mess["content"]; ?></td>
              <td align="center"><?php echo $mess["date"]; ?></td>
             
              <td align="center"><a class="red" href="message.php?action=delete&amp;id=<?php echo $mess["id"];?>" title="Delete">	<i class="icon-trash bigger-130"></i></a></td>              
