...
(function(b) {
	...
	a.prototype = {
		...
		error: function(g) {
			var e = this.$form.find(".control-group"),
				f = this.$form.find(".editable-error-block"),
				c;
			if (g === false) {
		...
		save: function(d) {
			...
			var c = (typeof this.options.pk === "function") ? this.options.pk.call(this.options.scope) : this.options.pk,
				e = !!(typeof this.options.url === "function" || (this.options.url && ((this.options.send === "always") || (this.options.send === "auto" && c !== null && c !== undefined)))),
				f;
			if (e) {
				this.showLoading();
				f = {
		...
		init: function(e, d) {
			...
			if (!c(document).data("editable-handlers-attached")) {
				...
				c(document).on("click.editable", function(j) {
					var f = c(j.target),
						g, h = [".editable-container", ".ui-datepicker-header", ".datepicker", ".modal-backdrop", ".bootstrap-wysihtml5-insert-image-modal", ".bootstrap-wysihtml5-insert-link-modal"];
...
(function(b) {
	...
	b.extend(a.prototype, {
		...
		toggleClear: function(d) {
			...
			var c = this.$input.val().length,
				f = this.$clear.is(":visible");
			if (c && !f) {
				this.$clear.show()
			}
			if (!c && f) {
...
(function(b) {
	...
	b.extend(a.prototype, {
		...
		value2htmlFinal: function(f, d) {
			var c = [],
				e = b.fn.editableutils.itemsByValue(f, this.sourceData);
			if (e.length) {
	...
	a.extend(b.prototype, {
		...
		value2input: function(e) {
			...
			if (this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
				var f = this.options.select2.id,
					c = this.options.select2.formatSelection;
				if (!f && !c) {
					var d = {
						id: e,
	...
	a.prototype = {
		...
		getTemplate: function() {
			...
			b.each(this.map, function(e, d) {
				d = d[0];
				var g = new RegExp(d + "+"),
					f = d.length > 1 ? d.substring(1, 2) : d;
				c = c.replace(g, "{" + f + "}")
			});
			c = c.replace(/ /g, "&nbsp;");
			b.each(this.map, function(e, d) {
		...
		fillDay: function() {
			var d = this.initItems("d"),
				e, f, c = this.options.template.indexOf("DD") !== -1;
			for (f = 1; f <= 31; f++) {
		...
		fillMonth: function() {
			var d = this.initItems("M"),
				e, f, h = this.options.template.indexOf("MMMM") !== -1,
				g = this.options.template.indexOf("MMM") !== -1,
				c = this.options.template.indexOf("MM") !== -1;
			for (f = 0; f <= 11; f++) {
				if (h) {
		...
		fillYear: function() {
			var c = [],
				d, e, f = this.options.template.indexOf("YYYY") !== -1;
		...
		fillHour: function() {
			var e = this.initItems("h"),
				f, h, k = this.options.template.indexOf("h") !== -1,
				j = this.options.template.indexOf("H") !== -1,
				d = this.options.template.toLowerCase().indexOf("hh") !== -1,
				g = k ? 1 : 0,
				c = k ? 12 : 23;
			for (h = g; h <= c; h++) {
		...
		fillMinute: function() {
			var d = this.initItems("m"),
				e, f, c = this.options.template.indexOf("mm") !== -1;
		...
		fillSecond: function() {
			var d = this.initItems("s"),
				e, f, c = this.options.template.indexOf("ss") !== -1;
		...
		fillAmpm: function() {
			var d = this.options.template.indexOf("a") !== -1,
				e = this.options.template.indexOf("A") !== -1,
				c = [
					["am", d ? "am" : "AM"],
					["pm", d ? "pm" : "PM"]
				];
		...
		setValue: function(f) {
			...
			var e = typeof f === "string" ? moment(f, this.options.format) : moment(f),
				d = this,
				c = {};
	...
	a.extend(a.fn.editableContainer.Popup.prototype, {
		...
		setPosition: function() {
			(function() {
				...
				e = /in/.test(f);
				g.removeClass("top right bottom left").css({
					top: 0,
					left: 0,
					display: "block"
				});
...
(function(g) {
	...
	h.prototype = {
		...
		_trigger: function(p, q) {
			var o = q || this.date,
				n = new Date(o.getTime() + (o.getTimezoneOffset() * 60000));
			this.element.trigger({
				type: p,
				date: n,
				format: g.proxy(function(s) {
		...
		fill: function() {
			...
			var I = k(w, G - 1, 28, 0, 0, 0, 0),
				D = i.getDaysInMonth(I.getUTCFullYear(), I.getUTCMonth());
			I.setUTCDate(D);
	...
	m.prototype = {
		...
		dateUpdated: function(q) {
			var r = g(q.target).data("datepicker"),
				p = r.getUTCDate(),
				o = g.inArray(q.target, this.inputs),
...
(function(a) {
	...
	a.extend(b.prototype, {
		initPicker: function(c, d) {
			...
			this.options.datetimepicker = a.extend({}, d.datetimepicker, c.datetimepicker, {
				format: this.options.viewformat
			});
...
(function(a) {
	...
	a.extend(b.prototype, {
		...
		input2value: function() {
			if (this.getIsObjects()) {
				var d = this.$input.data("value"),
					c = a.fn.editableutils.itemsByValue(d, this.sourceData);
