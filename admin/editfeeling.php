...
<?php
	...
	if(is_array($_POST)&&count($_POST)>0)//先判断是否通过Post提交了请求
    {
	      ...
	      if(isset($_POST["id"]))
	       {
	        ...
	        {  
	         $uploads_dir = '../gallery/uploads/feeling/';
	    ...
	    mysql_query("set names 'utf8'");
			$sql ="UPDATE `news` SET `date` = '$date',`title` = '$title',`writer` = '$writer',`content` = '$content'
			WHERE `news`.`id` =$id";
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                    <form class="form-horizontal" role="form" action="editfeeling.php" method="post" enctype="multipart/form-data">
                                 <input type="hidden" name="id" value="<?php echo $ff["id"]; ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 文章标题 </label>

										<div class="col-sm-9">
											<input name="title" type="text" id="form-field-1" class="col-xs-10 col-sm-5" value="<?php echo $ff["title"];?>" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input name="writer" type="text" id="form-field-1" class="col-xs-10 col-sm-5" value="<?php echo $ff["writer"];?>" />
										</div>
									</div>
														...
														<div class="row">
															<div class="col-xs-6 col-sm-3">
																<div class="input-group">
																	...
																	type="text" data-date-format="yyyy-mm-dd" value="<?php echo $ff["date"];?>"/>
									...
									<div class="space-8"></div>
										...
										<div class="col-sm-9">
											...
											id="form-input-readonly" value="艺术感悟" />
                                 ...
                                 <div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<textarea class="form-control editable" name="content" id="about" rows="12"><?php echo $ff["content"];?></textarea>
										</div>
									</div>
									<div class="space-4"></div>
