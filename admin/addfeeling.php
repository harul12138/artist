...
{  
   ...
   mysql_query("set names 'utf8'");
     $sql = "INSERT INTO `news` (`title` ,`date` ,`writer`,`picture`,`content`,`category`) 
     VALUES ('$fileTitle' , '$date' ,'$writer','$fileName','$fileInfo','$category')";
       
          $result=mysql_query($sql);  
          if($result>0)
        {  
         echo"<script type='text/javascript'>alert('上传成功');; 
      location='addfeeling.php';</script>"; 
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-warning">
											...
											本部分主要是上传艺术家自己撰写的相关文章，如谈山水画创作心得等
											<br />
										</div>
                                   <form class="form-horizontal" role="form" action="addfeeling.php" method="post" enctype="multipart/form-data" >
                           ...
                           <hr/>
                                  ...
                                  <div class="form-group">
									...
									<div class="space-8"></div>
										...
										<div class="col-sm-9">
											<input readonly="" type="text" class="col-xs-10 col-sm-5" name="category" id="form-input-readonly" value="艺术感悟" />
