    ...
    if(!strcmp($reqAct,"delete"))
    {
      ...
      if(intval($id)>=0)
      {
         ...
         if(!$result)
        {
          ...
          echo"<script type='text/javascript'>window.alert('事件删除失败');; 
      location='timelist.php';</script>"; 
        }
        else
        {
          echo"<script type='text/javascript'>window.alert('事件删除成功');; 
      location='timelist.php';</script>"; 
        }
      }
    }
...
?>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
             ...
             mysql_query("set names 'utf8'");
              $time="select * from timeline order by id DESC";
    ...
    {   ?>
            ...
            <tr height="35">
                    <td align="center"><?php echo $tt["date"];?></font></a></td>
              <td colspan="4"><?php echo $tt["event"]; ?></td>

			<td align="center">
				<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

				<a class="green" href="moditime.php?action=modify&id=<?php echo $tt["id"];?>" title="Edit" >
					<i class="icon-pencil bigger-130"></i>
				</a>

				<a class="red" href="timelist.php?action=delete&amp;id=<?php echo $tt["id"];?>" title="Delete">
