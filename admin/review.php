						...
						<div class="row">
							<div class="col-xs-12">
		                        ...
		                        <div class="alert alert-info">
											...
											本部分主要是与艺术家相关的文章评论，如他人为艺术家作的序或写的作品评论
											<br />
										</div>
...
<?php
             ...
             mysql_query("set names 'utf8'");
              $re="select * from news where category='艺术礼记' order by id DESC";
    ...
    {   ?>
                                                  ...
                                                  <td><?php echo $rr["writer"];?></td>
                                                      <td><?php echo mb_strlen($rr['content'], 'utf-8') > 50 ? mb_substr($rr['content'], 0, 50, 'utf-8').'....' : $rr['content'];?></td>

														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

																<a class="green" href="editreview.php?action=modify&id=<?php echo $rr["id"];?>" title="Edit" >
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="review.php?action=delete&amp;id=<?php echo $rr["id"];?>" title="Delete">
