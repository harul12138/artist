...
{  
   ...
   mysql_query("set names 'utf8'");
     $sql = "INSERT INTO `salework` (`title` ,`filesize`,`size` ,`price`,`picture`,`info`) 
     VALUES ('$fileTitle' , '$filesize' ,'$size0' ,'$price','$fileName','$fileInfo')";
       
          $result=mysql_query($sql);  
          if($result>0)
        {  
         echo"<script type='text/javascript'>alert('上传成功');; 
      location='adsalework.php';</script>"; 
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                    <form class="form-horizontal" role="form" action="adsalework.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="action" value="upload">
                                    <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 作品图片 </label>
                                 <div class="col-sm-4">
                           ...
                           <hr/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input data-rel="tooltip" type="text" name="size" id="form-field-6" placeholder="xxcm*xxcm" data-placement="bottom" />
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input data-rel="tooltip" type="text" name="price" id="form-field-6" placeholder="可为议价" title="例：16000元" data-placement="bottom" class="col-xs-10 col-sm-5" />
