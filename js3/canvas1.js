(function() {
    ...
    var colors = ['157,41,51', '22,169,81', '22,133,169', '0,52,114', '255,182,30','191,36,42'];
    ...
    function tweenTriangle(tri) {
        ...
        var x = (200+Math.random()*100)*Math.cos(t) + width*0.7;
        var y = (200+Math.random()*100)*Math.sin(t) + height*0.5-20;
        var time = 4+2*Math.random();
