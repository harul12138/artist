! function(t, e) {
	...
	function e(t) {
		var e = e || s.createDocumentFragment(),
			n = n || e.appendChild(s.createElement("div"));
	...
	d.extend({
		addClass: function(t) {
			...
			return this.each(function(t) {
				if (n = i.length, t.classList)
					...
					for (; n--;) e = " " + t.className + " ", -1 === e.indexOf(" " + i[n] + " ") && (t.className += " " + i[n])
			}), this
		},
		attr: function(t, e) {
		...
		removeClass: function(t) {
			var e, n, i = t.match(m);
			return this.each(function(t) {
				if (e = i.length, t.classList)
					for (; e--;) t.classList.remove(i[e]);
				else {
		...
		off: function(e, n) {
			return this.each(function(i) {
				if (n) i.removeEventListener(e, n);
					...
					for (var r in p[t(i).data("cshid")][e]) i.removeEventListener(e, p[t(i).data("cshid")][e][r])
			}), this
		},
		on: function(e, n, i) {
	...
	return d.extend({
		serialize: function() {
			var t, e, n, i = this[0],
				r = "";
			for (e = i.elements.length - 1; e >= 0; e--)
				if (t = i.elements[e], t.name && "file" !== t.type && "reset" !== t.type)
					if ("select-multiple" === t.type)
						for (n = i.elements[e].options.length - 1; n >= 0; n--) t.options[n].selected && (r += "&" + t.name + "=" + g(t.options[n].value).replace(/%20/g, "+"));
